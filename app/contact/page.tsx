        ...
        <div className="space-y-6">
          <div className="rounded-3xl border border-[#E5E7EB] bg-white p-8 shadow-sm">
            <p className="text-sm font-semibold uppercase tracking-[0.16em] text-[#0F4C81]">
              <LocalizedText en="Contact" bm="Hubungi" />
            </p>
            <h1 className="mt-3 text-4xl font-semibold tracking-tight text-[#1F2933]">
              <LocalizedText en={`Contact ${SITE_NAME_FULL}`} bm={`Hubungi ${SITE_NAME_FULL}`} />
            </h1>
            <p className="mt-4 text-base leading-7 text-[#6B7280]">
              <LocalizedText
                en="Use WhatsApp for the fastest response, or check our two main branch details below."
                bm="Gunakan WhatsApp untuk respon paling cepat, atau semak maklumat dua cawangan utama kami di bawah."
              />
            </p>
            ...
            <div className="mt-8 space-y-4 text-sm text-[#4B5563]">
              <p className="flex items-start gap-3">
                ...
                <span>
                  <LocalizedText en="Main WhatsApp" bm="WhatsApp utama" />: +
                  {WHATSAPP_NUMBER}
                </span>
              </p>
              <p className="flex items-start gap-3">
                ...
                <span>
                  <LocalizedText en="Service area" bm="Kawasan servis" />:{" "}
                  {SERVICE_REGIONS.join(", ")}
                </span>
              </p>
          ...
          <div className="rounded-3xl border border-[#E5E7EB] bg-[#F7F8FA] p-8 shadow-sm">
            ...
            <div className="mt-5 flex min-h-72 items-center justify-center rounded-2xl border border-dashed border-[#CBD5E1] bg-white text-sm text-[#6B7280]">
              <LocalizedText en="Search on Google Maps" bm="Cari di Google Maps" />:{" "}
              {SITE_NAME_FULL}
            </div>
          </div>
        </div>
